...
#JOHAN
$patrick = new Person('./items/johan/pat.PNG', 100, 'Patrick', 'Directeur', ['Caroline', 'Nabil', 'Gabriel', 'Olege', 'Johan', 'Charles', 'Yoann', 'Herve', 'Groupe Rouge', 'Balibaris', 'Intuitae'], ['6', '3', '6','1', '3','1', '1','6', '1', '1','1' ]);
...
#PAUL
$olivierS = new Person('./items/paul/olivierS.JFIF', 101, 'OlivierS', 'DG', ['JeanGuy', 'Alexandre', 'Katia', 'JeanChristophe', 'OlivierK'], ['6', '3', '3', '3', '3']);
$jeanGuy = new Person('./items/paul/jeanGuy.JFIF', 101, 'JeanGuy', 'D_adj', ['OlivierS', 'Alexandre', 'Katia', 'JeanChristophe', 'OlivierK'], ['6', '3', '3', '3', '3']);

$jeanChristophe = new Person('./items/paul/jeanChristophe.PNG', 101, 'JeanChristophe', 'DSI', ['OlivierS', 'Mohamed', 'GuillaumeT', 'Julie', 'Katia'], ['3', '6', '6', '6', '3']);
...
$olivierK = new Person('./items/paul/olivierK.JFIF', 101, 'OlivierK', 'DJ', ['Katia', 'Nadia', 'Murielle'], ['3', '6', '6']);
$murielle = new Person('./items/paul/murielle.JFIF', 101, 'OlivierK', 'Juriste', ['olivierK', 'Matthieu'], ['3', '6', '6', '6']);
$nadia = new Person('./items/paul/olivierK.JFIF', 101, 'OlivierK', 'Juriste', ['OlivierK', 'Murielle'], ['3', '6', '6', '6']);

$alexandre = new Person('./items/paul/alexandre.JFIF', 101, 'Alexandre', 'DF', ['Hadrien', 'Veralda', 'Katia'], ['6', '6', '3']);
$hadrien = new Person('./items/paul/hadrien.JFIF', 101, 'Hadrien', 'DF', ['Alexandre', 'Veralda'], ['6', '6']);
$veralda = new Person('./items/paul/veralda.JFIF', 101, 'Veralda', 'DF', ['Alexandre', 'Hadrien'], ['6', '6']);

$katia = new Person('./items/paul/katia.JFIF', 101, 'Katia', 'DC', ['OlivierS', 'Alexandre', 'JeanChristophe'], ['3', '6', '6', '6']);
$elodie = new Person('./items/paul/elodie.JFIF', 101, 'Elodie', 'Stagiaire', ['Katia', 'Sidney'], ['6', '6']);
$sidney = new Person('./items/paul/sidney.JPG', 101, 'Sidney', 'Media', ['Katia', 'Elodie'], ['6', '6']);
...
$olivierK, $hadrien, $alexandre, $veralda, $katia, $sidney, $elodie);
...
{
	$x = $x_start + 0.75 * $x_start + $r * cos($theta_variable);
	$y = $y_start + 1.25 * $x_start + $r * sin($theta_variable);
